            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    ...
                    <li data-name="senior" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd>
                                <a lay-href="${pageContext.request.contextPath}/admin/blogList">博客资源管理</a>
                            </dd>
                            <dd>
                                <a lay-href="${pageContext.request.contextPath}/admin/userList">用户账户管理</a>
                            </dd>
                        </dl>
                    </li>
                    <li data-name="user" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd>
                                <a lay-href="${pageContext.request.contextPath}/userlistUI.jsp">帖子管理</a>
                            </dd>
                            <dd>
                                <a lay-href="${pageContext.request.contextPath}/userlistUI.jsp">发帖人管理</a>
                            </dd>
                        </dl>
                    </li>
