...
<%--        <select id="articleCategory"></select>--%>
        <span id="btnList">
				<button type="button" id="publishArticle" onclick="writeArticle.doSubmit();" class="btn btn-info">发布博客</button>
        </span>
        <br/>
        <br/>
    </header>
