                        ...
                        <div class="span8 main-listing">
                            ...
                            <article class="format-standard type-post hentry clearfix">
                                ...
                                <header class="clearfix">
                                    ...
                                    <h3 class="post-title">
                                        <a href="${pageContext.request.contextPath}/article/queryArticleByArticleId?articleId=${mostHotArticle.articleId}">${mostHotArticle.articleTitle}</a>
                                    </h3>
                        ...
                        <div class="span8 main-listing">
                            ...
                            <article class="format-standard type-post hentry clearfix">
                                ...
                                <header class="clearfix">
                                    ...
                                    <h3 class="post-title">
                                        <a href="${pageContext.request.contextPath}/article/queryArticleByArticleId?articleId=${latestArticle.articleId}">${latestArticle.articleTitle}</a>
                                    </h3>
